...
if (empty($_SERVER['PHP_AUTH_USER']) || empty($_SERVER['PHP_AUTH_PW'])) {
  ...
  $dbh = new PDO('mysql:host=localhost;dbname=u20335', $user, $password,
  array(PDO::ATTR_PERSISTENT => true));
  $sth = $dbh->prepare("SELECT pass FROM adminbase WHERE login = ?");
...
if(isset($_GET['logout'])) {
  header('Location: http://logout@u20335.kubsu-dev.ru/task_6/admin.php');
  exit();
}
